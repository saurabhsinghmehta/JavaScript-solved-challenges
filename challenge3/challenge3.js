...
if (dolphinsAverageScore > kolasAverageScore) {
    compWinner = (`dolphins are the winners 🏆`);
}
else if (kolasAverageScore > dolphinsAverageScore) {
    (`kolas are the winners with ${kolasAverageScore} Score`);
}

else if (dolphinsAverageScore === kolasAverageScore) {
    compWinner = ("The result is draw");
